                                ...
                                <div class="panel-body">
                                    ...
                                    <form class="form-horizontal" wire:submit.prevent="createNewService">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" id="discount" name="discount" class="form-control" placeholder="discount" wire:model="discount" required/>
                                                @error('discount')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <select id="discount_type" name="discount_type" class="form-control" wire:model="discount_type" required>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="file" id="thumbnail" name="thumbnail" class="form-control-file" wire:model="thumbnail" required/>
                                                @if($thumbnail)
                                                    <img src="{{ $thumbnail->temporaryUrl() }}" width="20%" height="20%" alt="thumbnail">
                                                @endif
                                                @error('thumbnail')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
